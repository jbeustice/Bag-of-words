...
## This program develops a multiple bag-of-words models to classify IMDb movie
## reviews as positive or negative. A sample set of 50k reviews are used to
## train and validate the models (NB and SVM) using both word occurance and
## TF-IDF algorithms. 
...
# call function f_ReadIn() and combines in one df
